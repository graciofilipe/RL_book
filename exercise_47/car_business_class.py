...
class CarBusiness:
    def __init__(self, rental_profit, transport_cost,
        ...
        self.cars_at_0 = initial_state[0]
        self.cars_at_1 = initial_state[1]
    ...
    def action_car_returns(self):
        returned_0 = random.poisson(self.lambda_returns_0)
        returned_1 = random.poisson(self.lambda_returns_1)
        self.cars_at_0 += returned_0
        self.cars_at_1 += returned_1

    def action_car_requests(self):
        requested_0 = random.poisson(self.lambda_requests_0)
        requested_1 = random.poisson(self.lambda_requests_1)
        rented_cars_at_0 = min(requested_0, self.cars_at_0)
        rented_cars_at_1 = min(requested_1, self.cars_at_1)
        self.cars_at_0 -= rented_cars_at_0
        self.cars_at_1 -= rented_cars_at_1
        return [rented_cars_at_0, rented_cars_at_1]

    def move_cars(self, cars_to_move_0_to_1):
        '''
        :param cars_to_move_1_to_2: integer number of cars to move. If negative, move from 2 to 1
        :return:
        '''
        self.cars_at_0 -= cars_to_move_0_to_1
        self.cars_at_1 += cars_to_move_0_to_1
