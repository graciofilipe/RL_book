...
def test_sarsa_creates_better_policy():
    ...
    ## bad
    environment_bad, agent_bad = create_environment_agent_and_states(grid_shape=(5, 5),
                                                             initial_position=(0, 2),
                                                             final_position=(2, 4),
                                                             epsilon=0.2)
    ...
    for i in range(n_sims):
        ...
        state_action_tuple_list_bad, reward_list_bad = episode_simulator.run_episode(start_state=(0, 2))
        bad_list.append(sum(reward_list_bad))



    ## good
    environment_good, agent_good = create_environment_agent_and_states(grid_shape=(5, 5),
                                                                     initial_position=(0, 2),
                                                                     final_position=(2, 4),
                                                                     epsilon=0.2)
    ...
    for i in range(n_sims):
        ...
        state_action_tuple_list_good, reward_list_good = episode_simulator.run_episode(start_state=(0, 2))
