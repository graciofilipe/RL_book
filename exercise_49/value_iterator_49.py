...
class ValueIterator:
    ...
    def get_list_of_reacheable_states(self, environment):
        return environment.get_currently_recheable_states()
    ...
    def run_value_iteration(self, environment, agent):
        ...
        while keep_going:
            ...
            for state in list_of_all_states:
                ...
                #print('state:', state, 'best_action:', best_action, 'state_value:',
                #      state_value)
